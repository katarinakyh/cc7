...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('event_event', 'datetime_from',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 10, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('event_event', 'time_from',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2013, 3, 10, 0, 0)),
                      keep_default=False)
