(function($, _, Backbone) {
    ...
    Backbone.Tastypie.Model = Backbone.Model.extend({
        ...
        _getId: function() {
            ...
            return _.chain(this.get('resource_uri')
                .split('/'))
                .compact()
                .last()
                .value();
    ...
    Backbone.Tastypie.Collection = Backbone.Collection.extend({
        constructor: function(models, options) {
            ...
            if (options && options.filters) _.extend(this.filters, options.filters);
        },
        url: function(models) {
        ...
        parse: function(response) {
            if (response && response.meta) this.meta = response.meta;
        ...
        fetchNext: function(options) {
            ...
            if (this.filters.offset > this.meta.total_count) this.filters.offset = this.meta.total_count;
    ...
    var getValue = function(object, prop) {
        if ((object && object[prop])) return _.isFunction(object[prop]) ? object[prop]() : object[prop];
    };
