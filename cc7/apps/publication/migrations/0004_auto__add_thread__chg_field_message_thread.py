...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'publication.message': {
            ...
            'thread': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['publication.Thread']"}),
        ...
        'publication.thread': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modifies': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
