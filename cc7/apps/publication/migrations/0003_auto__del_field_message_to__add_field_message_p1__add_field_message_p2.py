...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('publication_message', 'to_id')

        # Adding field 'Message.p1'
        db.add_column('publication_message', 'p1',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='p1', to=orm['account.MyProfile']),
                      keep_default=False)

        # Adding field 'Message.p2'
        db.add_column('publication_message', 'p2',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='p2', to=orm['account.MyProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Message.to'
        db.add_column('publication_message', 'to',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['account.MyProfile']),
                      keep_default=False)

        # Deleting field 'Message.p1'
        db.delete_column('publication_message', 'p1_id')

        # Deleting field 'Message.p2'
        db.delete_column('publication_message', 'p2_id')
    ...
    models = {
        ...
        'publication.message': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'p1': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'p1'", 'to': "orm['account.MyProfile']"}),
            'p2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'p2'", 'to': "orm['account.MyProfile']"}),
