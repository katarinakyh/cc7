...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.place'
        db.add_column('publication_post', 'place',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['map.Place'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Post.place'
        db.delete_column('publication_post', 'place_id')
