...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('publication_post', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['image.Image'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.image'
        db.delete_column('publication_post', 'image_id')
    ...
    models = {
        ...
        'publication.post': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['image.Image']", 'null': 'True', 'blank': 'True'}),
