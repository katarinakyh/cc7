...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('publication_post', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['group.Group'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.group'
        db.delete_column('publication_post', 'group_id')
