...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('publication_comment', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Event'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Comment.post'
        db.alter_column('publication_comment', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publication.Post'], null=True))

    def backwards(self, orm):
        # Deleting field 'Comment.event'
        db.delete_column('publication_comment', 'event_id')
