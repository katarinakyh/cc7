...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Post.image' to match new field type.
        db.rename_column('publication_post', 'image_id', 'image')
        # Changing field 'Post.image'
        db.alter_column('publication_post', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
        # Removing index on 'Post', fields ['image']
        db.delete_index('publication_post', ['image_id'])


    def backwards(self, orm):
        # Adding index on 'Post', fields ['image']
        db.create_index('publication_post', ['image_id'])


        # Renaming column for 'Post.image' to match new field type.
        db.rename_column('publication_post', 'image', 'image_id')
        # Changing field 'Post.image'
        db.alter_column('publication_post', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['image.Image'], null=True))
